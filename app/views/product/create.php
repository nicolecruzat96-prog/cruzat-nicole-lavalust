...
<body>
    ...
    <main class="editor-window">
        ...
        <div class="title-bar">
            ...
            <div class="title-bar-label">products — create.php</div>
        </div>

        <nav class="tab-strip">
            <div class="tab">
                <span class="tab-icon">●</span> create.php
            </div>
        </nav>
        ...
        <div class="content-pane">
            ...
            <div class="terminal-header">
                <div>
                    <span class="prompt">admin@system</span><span class="path">~/products</span>$ <span class="cmd">php create.php --new</span>
                </div>
                <a href="<?= site_url('/product/display'); ?>" class="back-link">← Back to products</a>
            </div>

            <form action="<?= site_url('/product/create'); ?>" method="post" class="add-form">
        ...
        <div class="status-bar">
            ...
            <span class="status-right">New Entry</span>
        </div>
